...
#ifndef CAFFE_PIFA_HPP_
#define CAFFE_PIFA_HPP_
...
class DataPifaLayer: public BasePrefetchingDataLayer<Dtype>
{

public:

    explicit DataPifaLayer(const LayerParameter& param)
        : BasePrefetchingDataLayer<Dtype>(param) {}
    virtual ~DataPifaLayer();
    virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
                                const vector<Blob<Dtype>*>& top);

    virtual inline const char* type() const { return "DataPifamap"; }
...
protected:
    ...
    inline void GetCurImg(string& img_name, std::vector<float>& img_class, std::vector<float>& crop_info);
