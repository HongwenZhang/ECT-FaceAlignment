...
class DataDetectmapLayer: public BasePrefetchingDataLayer<Dtype>
{

public:

    explicit DataDetectmapLayer(const LayerParameter& param)
        : BasePrefetchingDataLayer<Dtype>(param) {}
    virtual ~DataDetectmapLayer();
    virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
                                const vector<Blob<Dtype>*>& top);

    virtual inline const char* type() const { return "DataDetectmap"; }
