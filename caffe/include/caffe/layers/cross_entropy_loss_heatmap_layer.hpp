#ifndef CAFFE_CROSS_ENTROPY_LOSS_HEATMAP_HPP_
#define CAFFE_CROSS_ENTROPY_LOSS_HEATMAP_HPP_
...
class CrossEntropyLossHeatmapLayer : public LossLayer<Dtype> {
public:
  explicit CrossEntropyLossHeatmapLayer(const LayerParameter& param)
...
//  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top);
  ...
  virtual inline const char* type() const { return "CrossEntropyLossHeatmap"; }
...
protected:
  ...
  Blob<Dtype> logp_pred_;
  Blob<Dtype> logoneSubp_pred_;
...
#endif /* CAFFE_CROSS_ENTROPY_LOSS_HEATMAP_HPP_ */
